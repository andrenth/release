...
(* OASIS_START *)
(* DO NOT EDIT (digest: e130d625a2047970290a04a4ba5fb258) *)
(*
...
let setup_t =
  {
       ...
       [
          ("release",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "lib/release"})
       ];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("async",
                               Some (OASISVersion.VGreaterEqual "0.9.0"));
                           FindlibPackage
                             ("async_extended",
                               Some (OASISVersion.VGreaterEqual "0.9.0"));
     ...
     oasis_digest = Some "\\\127?5\243\223\240\130\219\175\167\240\198\223NA";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
