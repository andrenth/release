...
(* OASIS_START *)
(* DO NOT EDIT (digest: 27dc038c76418d3ceddc971bde11cb8b) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ...
          ("release-buffer",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "lib/buffer"});
          ("release-bytes",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "lib/bytes"});
          ("release-config",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "lib/config"})
       ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "YG\190\231\189\132\007|F(k\189H\217\017\172";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
