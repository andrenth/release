...
(* OASIS_START *)
(* DO NOT EDIT (digest: 370f7a59f9272b2c6c2eb74d1874d1bf) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("release", OCamlbuildDocPlugin.doc_build "lib/core")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("release", OCamlbuildDocPlugin.doc_clean "lib/core")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "release-config"];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "ocamllex";
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\150\177\188\252\148\150\149w\142\136\241\254\180\200\218\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
