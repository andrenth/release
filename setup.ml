...
(* OASIS_START *)
(* DO NOT EDIT (digest: 34d79dc1bf46ff7f9d2b5c769cf56a5e) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("release", OCamlbuildDocPlugin.doc_build "lib/core");
          ("release-buffer", OCamlbuildDocPlugin.doc_build "lib/buffer");
          ("release-bytes", OCamlbuildDocPlugin.doc_build "lib/bytes");
          ("release-config", OCamlbuildDocPlugin.doc_build "lib/config")
       ];
     ...
     clean_doc =
       [
          ("release", OCamlbuildDocPlugin.doc_clean "lib/core");
          ("release-buffer", OCamlbuildDocPlugin.doc_clean "lib/buffer");
          ("release-bytes", OCamlbuildDocPlugin.doc_clean "lib/bytes");
          ("release-config", OCamlbuildDocPlugin.doc_clean "lib/config")
       ];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Release_buffer"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "release";
                      lib_findlib_name = Some "buffer";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "release-buffer";
                           FindlibPackage
                             ("uint.uint32",
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Release_option"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "release";
                      lib_findlib_name = Some "option";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("lwt.syntax",
                               Some (OASISVersion.VGreaterEqual "2.4.0"));
                           InternalLibrary "release-option";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Release documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Release_buffer documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Release_bytes documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Release_config documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "slave.ml"; });
               Executable
                 ({
                     cs_name = "test_helper";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "masterctl.ml"; });
               Executable
                 ({
                     cs_name = "test_config";
                     cs_data = PropList.Data.create ();
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("lwt.syntax",
                               Some (OASISVersion.VGreaterEqual "2.4.0"));
                           InternalLibrary "release-config"
                        ];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                   ...
                   {exec_custom = false; exec_main_is = "config_test.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\142\216\188\242L\238\164\18170\152h\255\186\180>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
