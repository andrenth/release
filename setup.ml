...
(* OASIS_START *)
(* DO NOT EDIT (digest: d75a8e25afc93bd6582cc87bbbf23da5) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Release"; "Release_future"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "master_async.ml"});
               Executable
                 ({
                     cs_name = "async_test_slave";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "slave_async.ml"});
               Executable
                 ({
                     cs_name = "async_test_helper";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "helper_async.ml"});
               Executable
                 ({
                     cs_name = "async_masterctl";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "masterctl_async.ml"});
               Executable
                 ({
                     cs_name = "async_test_config";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "lib_test/config";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "release-async"];
                      bs_build_tools =
                        [
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "config_test_async.ml"
                   });
               Executable
                 ({
                     cs_name = "lwt_test_master";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "master_lwt.ml"});
               Executable
                 ({
                     cs_name = "lwt_test_slave";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "slave_lwt.ml"});
               Executable
                 ({
                     cs_name = "lwt_test_helper";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "helper_lwt.ml"});
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "masterctl_lwt.ml"});
               Executable
                 ({
                     cs_name = "lwt_test_config";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "lib_test/config";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "release-lwt"];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "ocamllex";
                   ...
                   {exec_custom = false; exec_main_is = "config_test_lwt.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\001\214<*\nMm\249\167J\250\159'jY\156";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
