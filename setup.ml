...
(* OASIS_START *)
(* DO NOT EDIT (digest: 32ac0006672d05bf4a6669a02144c623) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("release", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("release", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\245\201\019\251\142\189Ag>\141a\\ \187{\167";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
